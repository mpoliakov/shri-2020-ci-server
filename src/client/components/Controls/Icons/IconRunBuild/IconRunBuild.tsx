...
import Icon, {IconProps} from '@components/Controls/Icons/Icon/Icon';

const IconRunBuild: React.FC<IconProps> = (props) => {
  const {
    mix,
    width = 9,
    height = 10,
  ...
  return <Icon mix={`icon--run-build ${mix}`.trim()} width={width} height={height} viewBox="0 0 9 10">
